...
//	    				console.log("runshow" );
						...
						console.log("原系数: " + yuan_coeff);
						console.log("配平系数: " + balance_coeff);
						console.log("系数对比: " + coeff_diff_list);
...
//wx2019-10-26+17:24化学方程式
	var charLabel2char = {'a':'a', 'Ｏ':'O', 'Ｎ':'N', 'Ｈ':'H', '５':'5', '７':'7', '４':'4', '８':'8', '２':'2','６':'6', '９':'9',  '３':'3', '１':'1', '＋':'+', '＝':'=','↑':'↑' }; // 编码转换
